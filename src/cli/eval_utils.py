...
def plot_eval(df_gt, dir_out):
    ...
    print(f'reconstruction_error A = {df_gt[df_gt["anomaly"] == 0]["reconstruction_error"].mean()}')
    print(f'reconstruction_error B = {df_gt[df_gt["anomaly"] == 1]["reconstruction_error"].mean()}')
    ...
    ax.hist(reconstruction_error_0, bins=50, density=True, label="reconstruction_error A", alpha=.6, color="green")
    ax.hist(reconstruction_error_1, bins=50, density=True, label="reconstruction_error B", alpha=.6, color="red")
